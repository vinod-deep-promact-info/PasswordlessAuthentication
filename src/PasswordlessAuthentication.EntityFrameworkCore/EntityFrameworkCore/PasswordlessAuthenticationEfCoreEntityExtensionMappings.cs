...
public static class PasswordlessAuthenticationEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE PasswordlessAuthenticationModuleExtensionConfigurator CLASS (in the Domain.Shared project)
